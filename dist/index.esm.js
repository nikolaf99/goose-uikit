...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#DBFFF6", backgroundDisabled: "#E9EAEB", contrast: "#fb9a24", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: #fb9a24", textDisabled: "#BDC2C4", textSubtle: "#8f80ba", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
