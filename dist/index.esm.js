...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#effffb", backgroundDisabled: "#E9EAEB", contrast: "#fb9a24", invertedContrast: "#FFFFFF", input: "#ffebd4", tertiary: "#EFF4F5", text: "#fb9a24", textDisabled: "#BDC2C4", textSubtle: "#c97004", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
